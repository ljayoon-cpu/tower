...
const effects = {
  ...
  laser: [note(0,.16,2300,1500,.3,'saw'), note(0,.05,0,0,.07,'noise')],
  command: [note(0,.16,330,330,.24,'triangle'), note(.06,.22,494,494,.2,'triangle')],
  mine: [note(0,.09,1245,1660,.24,'triangle'), note(.085,.16,1975,1975,.2,'triangle')],
