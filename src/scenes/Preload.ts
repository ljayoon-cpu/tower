...
export class Preload extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.spritesheet('enemy_tank', 'art/enemies/tank-siege-walk-v1.png', {
      frameWidth: 128,
      frameHeight: 128,
    });
    this.load.spritesheet('enemy_shield', 'art/enemies/shield-soldier-walk-v1.png', {
      frameWidth: 128,
      frameHeight: 128,
    });
    ...
    this.load.spritesheet('enemy_summoner', 'art/enemies/rift-summoner-walk-v1.png', {
      frameWidth: 128,
      frameHeight: 128,
    });
    this.load.spritesheet('enemy_minion', 'art/enemies/assembly-drone-hover-v1.png', {
      frameWidth: 128,
      frameHeight: 128,
    });
