...
export const SFX_KEYS = ['arrow', 'cannon', 'frost', 'bolt', 'sniper', 'poison', 'laser', 'command', 'mine', 'hit', 'leak', 'place', 'merge', 'sell', 'wave', 'clear', 'lose', 'click'] as const;
...
const INTERVAL: Record<SfxKey, number> = {
  arrow: 100, cannon: 160, frost: 140, bolt: 140, sniper: 240, poison: 170,
  laser: 130, command: 400, mine: 900, hit: 120, leak: 250,
